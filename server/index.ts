...
app.get('/api/health', (_request, response) => response.json({ configured: Boolean(process.env.OPENAI_API_KEY) }))
...
app.listen(port, () => console.log(`StudyForge AI server listening on http://localhost:${port}`))
