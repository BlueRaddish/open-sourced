...
export function Shell({ view, navigate, children }: Props) {
  ...
  return <div className="app-shell">
    <header className="topbar">
      <button className="brand" onClick={() => go('home')} aria-label="StudyForge home">
        <span className="brand-mark"><BookOpen size={21} /></span>
        <span>study<span>forge</span></span>
      </button>
    ...
    <main>{children}</main>
    <footer><div className="brand mini"><span className="brand-mark"><BookOpen size={16} /></span><span>study<span>forge</span></span></div><p>Your learning stays in your browser.</p><a href="https://github.com/BlueRaddish/studyforge">Open source on GitHub</a></footer>
  </div>
}
