...
type Props = { set: StudySet; progress: Record<string, CardProgress>; navigate: (view: View) => void; edit: () => void; duplicate: () => void; remove: () => void; share: () => Promise<string> }

export function SetDetail({ set, progress, navigate, edit, duplicate, remove, share }: Props) {
